...
def updateItems(profile ,scenario_id ,dbName ,emails ,userKeyIds , userKeySecrets, usernames, attempts) :
    # Initialize session
...
updateItems(profile ,scenario_id ,dbName ,emails ,userKeyIds ,userKeySecrets,usernames, attempts)